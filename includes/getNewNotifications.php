...
$id = $_SESSION['user_id'];
$getNotis = "SELECT * FROM notification_system WHERE recipient_id=$id AND noti_status='unread' ORDER BY noti_id DESC;";
...
if($resultNum > 0){
  for($counter = 0; $counter < $resultNum; $counter++){
    ...
    $updateNotiStatus = "UPDATE notification_system SET noti_status='read' WHERE noti_id=?;";
