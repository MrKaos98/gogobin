...
<body>
  ...
  ?>
            ...
            <div id="current-order-outer">
              ...
              <?php
                ...
                if($resultRows < 1){
                  ...
                  echo "<p style='text-align: center'><a href='../homepage/foodbin.php' id='order-now-btn'>Order Now</a></p>";
                } else {
    ...
    <div id="edit-modal-window"></div>
    <section id="edit-modal-container">
      <div id="edit-modal-body">
        <div id="close-edit-modal-btn">
    ...
    <section id="convos-body-wrapper">
      <div id="convos-body">
