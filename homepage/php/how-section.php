        ...
        <div class='hiw-row-inner'>
          <div class='image-caption left-caption'>
            <div class='image-caption-inner' id='caption-two'>
              ...
              <ul>
                <li>View food items from different categories</li>
                <li>Click on a given item to select item specs</li>
                <li>After selecting food specifics, add to cart</li>
              </ul>
            </div>
          </div>
          <input type='image' src='../img/chooseitems.PNG' alt='Item Selection' id='image-two'/>
          <div class='image-caption' id='hidden-caption'>
        ...
        <div class='hiw-row-inner'>
          ...
          <div class='image-caption right-caption'>
            <div class='image-caption-inner' id='caption-three'>
              ...
              <h1>Ordering</h1>
              <ul>
                <li>Edit your order even after submitting for delivery</li>
                <li>Talk with delivery person with messaging system</li>
                <li>Select from save previous orders for repeat ordering</li>
              </ul>
            </div>
          </div>
        </div>
